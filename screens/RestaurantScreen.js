import {TouchableOpacity, View, Text, SafeAreaView,ScrollView, Image } from 'react-native';
...
import { setRestaurant } from '../features/restaurant/restaurant';
...
const RestaurantScreen = () => {
    ...
    <ScrollView>
      ...
      <View className="pd-36">
        <Text className="px-4 pt-6 mb-3 font-bold text-xl">Menu</Text>
        {/* dishes */}
        {dishes.map(dish=>{
            return <DishRow key={dish._id} id={dish._id} name={dish.dish} description={dish.short_description} price={dish.price} image={dish.image} />
        })}
      </View>
    </ScrollView>
    </>
