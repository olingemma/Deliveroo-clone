    ...
    <SafeAreaView className="bg-white pt-5">
      <View className="text-red-500">
        ...
        <View className="flex-row items-center space-x-2 pb-2 mx-4 px-4" >
          <View className="flex-row flex-1 rounded p-3 space-x-2 items-center bg-gray-200">
        ...
        <ScrollView className="pb-36">
          ...
          {featuredCategories?.map((category)=>{
            return <FeaturedRow  key={category.name} id={category._id} title={category.name} description={category.short_description}/>
          })}
